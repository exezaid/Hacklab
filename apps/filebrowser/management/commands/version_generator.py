...
class Command(NoArgsCommand):
    ...
    def handle_noargs(self, **options):
        import os, re
        from apps.filebrowser.settings import EXTENSION_LIST, EXCLUDE, MEDIA_ROOT, DIRECTORY, VERSIONS, EXTENSIONS
    ...
    def createVersions(self, path):
        ...
        from apps.filebrowser.settings import VERSIONS
        from apps.filebrowser.functions import version_generator
