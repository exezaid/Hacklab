...
# filebrowser imports
from apps.filebrowser.settings import *
from apps.filebrowser.functions import path_to_url, sort_by_attr, get_path, get_file, get_version_path, get_breadcrumbs, get_filterdate, get_settings_var, handle_file_upload, convert_filename
from apps.filebrowser.templatetags.fb_tags import query_helper
from apps.filebrowser.base import FileObject
from apps.filebrowser.decorators import flash_login_required
...
def mkdir(request):
    ...
    from apps.filebrowser.forms import MakeDirForm
...
def rename(request):
    ...
    from apps.filebrowser.forms import RenameForm
